...
exclude_patterns = [
    ...
    "chainopy.chainopy.tests.rst",
    "chainopy.chainopy._backend.rst",
    "chainopy.chainopy._caching.rst",
    "chainopy.chainopy._fileio.rst",
    "chainopy.chainopy._visualization.rst",
    "chainopy.chainopy._exceptions.rst",
    "modules.rst",
    "setup.rst",
    "_templates",
    "chainopy._*.rst",
